            ...
            <ul className=" flex flex-col">
                {
                    categories?.filter(c => c.parentId === 0).map((category, index) => (
                        <li key={index} className="flex flex-col  items-start gap-x-3.5 py-3 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:bg-gray-700 dark:border-gray-900 dark:text-white">

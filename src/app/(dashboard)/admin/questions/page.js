...
import CacheProvider from "@/util/CacheProvider"; // Kendi HttpClient wrapper'ınız
    ...
    useEffect(() => {
        const filtered = questions.filter((q) => {
            ...
            const matchesCategories =
                ...
                selectedCategories.some((cat) => q.categories.some((qc) => qc.id === cat.id))

            const matchesTags =
                selectedTags.length === 0 ||
                selectedTags.some((tag) => q.tags.some((qt) => qt.id === tag.id))
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <div className="relative" ref={filterMenuRef}>
                                ...
                                >
                                    ...
                                    {hasActiveFilters && (
                                        <span
                                            className="ml-1 rounded-full bg-gray-200 px-2 py-0.5 text-xs font-semibold text-gray-800">

        ...
        <section className="relative w-full h-[400px]">
            ...
            <div
                ...
                <p className="text-base sm:text-lg lg:text-left">
                    ...
                    İman, Fiqh və Siyarın İşığında – Mənəvi Səyahətinizə Yol Göstərir

                    Bu kanalda, iman həqiqətləri, fiqh və siyer mövzularında hazırlanmış məzmunlarla mənəvi dünyanızı
                    zənginləşdirir, bilgi birikiminizi artırır və doğru səyahətə çıxmanız üçün yol göstərişləri verir.
                    Kanalımızı izləyərək ilim və mənəviyyatın dərinliklərinə çata bilərsiniz.
                </p>
            </div>
        </section>
    );

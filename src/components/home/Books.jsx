            ...
            >
                {booksData.map((book) => (
                    <SwiperSlide key={book.id} className="!flex justify-center">
                        {/* Book Card */}
                        <div className="group flex w-full max-w-[220px] sm:max-w-[250px] flex-col items-center text-center">
                            <div className="relative aspect-[3/4] w-full overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:-translate-y-2 group-hover:shadow-xl">
                                <Image
                                    src={book.image}
                                    alt={book.title}
                                    fill
                                    ...
                                    priority={book.id <= 3} // Prioritize loading first few book images
                                />

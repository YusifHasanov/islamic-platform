...
const stats = [
    {
        ...
        platform: "Youtube",
        icon: <button className="bg-red-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
    ...
    {
        id: 2, name: 'Assets under holding', value: '119 million'
        , platform: "Facebook",
        icon: <button className="bg-blue-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">

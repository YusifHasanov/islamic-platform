...
const VideoComponent: FC<Video> = ({ id, title, videoId, thumbnail, publishedAt }) => {
    const router = useRouter();
     
    return (
        <div onClick={()=>router.push(`/videos/${videoId}`)} className="video_component dark:border-gray-700   hover:cursor-pointer flex bg-gray-100 dark:bg-gray-900  rounded-xl justify-center  " >

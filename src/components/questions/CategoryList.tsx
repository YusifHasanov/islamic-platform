            ...
            <div className='flex px-2 justify-center items-center overflow-auto categories_container'  >
                {
                    categories.filter(category => category.parentId === 0).map((parent) => (
                        <div key={parent.id} className="hs-dropdown  relative inline-flex">
                            <div id="hs-dropdown-with-icons"  key={parent.id} className="flex ml-1 hs-dropdown-toggle items-center justify-between p-2.5 rounded-md hover:bg-blue-100 bg-blue-50 dark:bg-gray-500 hover:dark:bg-gray-600 mr-1 cursor-pointer">

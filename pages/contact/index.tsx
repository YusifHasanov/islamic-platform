    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          ...
          <h2
            className="text-gray-700 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
          >
            Əlaqə
          </h2>
      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
        <div className="relative rounded-lg bg-gray-100 dark:bg-gray-700 p-8 shadow-lg sm:p-12">
          <form>
            <div className="mb-6">
              <input
                type="text"
